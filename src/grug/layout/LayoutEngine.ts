...
export class LayoutEngine {
    ...
    private _listener: ((layoutData: ItemLayoutData[], contentHeight: number) => void) | null = null;

    public setListener(listener: (layoutData: ItemLayoutData[], contentHeight: number) => void) {
